...
```
lxc launch ubuntu:24.04 CONTAINERNAME   # image and container names are optional 
lxc launch ubuntu:24.04/armhf armcont   # specific architecture
...
Disable the default network connection. The bridged connection should start automatically:
